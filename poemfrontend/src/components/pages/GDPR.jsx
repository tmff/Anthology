...
export const GDPR = (props) => {
    return(
        <div>
            ...
            <p>This privacy policy will explain how our organisation uses the personal
                 data we collect from you when you use our website. 
                 This policy is linked on our registration page and 
                 is always available in the footer of our application.  </p>
            ...
            <ul>
                ...
                <li>Voice recording of poem if uploaded  </li>
            </ul>
            <h2>How do we collect your data?</h2>
            <p>You directly provide Anthology with most of the data we collect.
                 We collect data and process data when you: </p>
            <ul>
                <li>Register for our app and you submit 
                    personal identification information to create an account </li>
                <li>Use or view our application with your browsers cookies </li>
                <li>By using your device's inbuilt location tracker  </li>
                <li>Voice recordings are collected if the user decides to upload a reading of their poem  </li>
            </ul>
            ...
            <ul>
                ...
                <li>Log the locations so that we can see where our app is most used to have a better understanding of our users and how we can improve the experience to retain or attract new users </li>
                <li>Voice recordings are displayed alongside the poem to allow other users to hear the poem from the author themselves and there is no further use for them.  </li>
            </ul>
            ...
            <ul>
                <li>Functionality cookies so our app recognises you and keeps you signed in while using our app. 
